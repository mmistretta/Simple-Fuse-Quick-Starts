...
public class ConsumerRouteTest extends CamelTestSupport {
    ...
    public void setUp() throws Exception {
        replaceRouteFromWith("jmsConsumer", "direct:jmsTestQueue");
        super.setUp();
    }

    /**
     * Tests Message Consumer Route by replacing the jms component with a direct
    ...
    public void testConsumeMessageRoute() throws Exception {
        // Get Mocks
        MockEndpoint incomingMsg = getMockEndpoint("mock:direct:jmsConsumer");
        MockEndpoint logEndpoint = getMockEndpoint("mock:log:jmsConsumerLog");
        ...
        template.sendBody("direct:jmsTestQueue", "Test JMS Message");
